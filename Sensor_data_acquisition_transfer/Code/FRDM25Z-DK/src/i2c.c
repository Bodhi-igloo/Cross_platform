...
/*----------------------------------------------------------------------------
 *  Function 'i2c_init': initialise i2c0
 *---------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
 *  Function 'i2c_wait': I2C wait function
 *---------------------------------------------------------------------------*/
#pragma no_inline 
void i2c_wait(void) {
	lock_detect = 0;
...
/*----------------------------------------------------------------------------
 *  Function 'i2c_start': send start sequence
 *---------------------------------------------------------------------------*/
void i2c_start()
{
...
/*----------------------------------------------------------------------------
 *  Function 'i2c_read_setup': send device and register addresses
 *---------------------------------------------------------------------------*/
#pragma no_inline 
...
/*----------------------------------------------------------------------------
 * Function 'i2c_repeated_read': Function to read a byte and ack/nack as appropriate
 *---------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------
 * Function 'i2c_read_byte':Function for reading and writing a single byte
...
/*----------------------------------------------------------------------------
 * Function 'i2c_write_byte': Using 7bit addressing writes a byte data to dev:address
 *---------------------------------------------------------------------------*/
