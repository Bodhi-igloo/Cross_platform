...
/*----------------------------------------------------------------------------
 *         Function 'init_mma': Function to initializes mma8451 sensor,
...
/*----------------------------------------------------------------------------
 *  Function 'read_full_xyz': Function to read and allign X,Y,Z axes data
 *---------------------------------------------------------------------------*/
void read_full_xyz()
{
	int i;
...
/*----------------------------------------------------------------------------
 *  Function 'read_xyz': Prudhvi check
 *---------------------------------------------------------------------------*/
void read_xyz(void)
{
